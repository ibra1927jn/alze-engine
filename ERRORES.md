...
- [2026-03-29] | ai/NavMesh.cpp:34-46 | build() hace clear() de neighbors dentro del loop de deteccion — borra vecinos ya agregados por iteraciones anteriores | **FIXED** Separado en dos pasadas: primero clear all, luego detect edges
