...
- [2026-04-23] | Heartbeat include-cleanup pass 3 | 100% — drop unused <algorithm> en CollisionSolver3D.h y SkeletalAnimation.h, <cstring> en ModelLoader.h. 1146/1146 tests OK.
- [2026-04-23] | Heartbeat include-cleanup pass 4 | 100% — drop unused <cstdlib> en Serializer.h, <cstdlib>/<cmath>/<cstring> en 7 renderer headers (ScreenEffects, SSAO, TextRenderer, SpriteBatch2D, Skybox, ProceduralTextures, EnvironmentMap), <cmath> en Constraints3D.h/RigidBody3D.h, <cmath>/<cstring>/<algorithm> en AudioEngine.h. 1146/1146 tests OK.
